  ...
  <div class="row">
    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form method="post" action="{{route('order.status.save',$orderstatus->id)}}" role="form">
          @csrf
          ...
          <div class="box-body">
            <div class="form-group">
              ...
              <input value="{{$orderstatus->status}}" name="status" type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Order Status">
            </div>
