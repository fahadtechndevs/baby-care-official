      ...
      <div class="box">
              ...
              <h3 class="box-title">
                <div class="row">
                  ...
                  <div class="col-md-6 text-right">
                    <a class="btn btn-primary" href="{{route('faqs.add')}}"><i class="fa fa-plus"></i> Add Faqs</a>
                  </div>
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                ...
                <tr role="row"><th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending" style="width: 125.8px;">Faq ID</th><th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 157px;">Question</th><th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 138.6px;">Answer</th><th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 138.6px;">Action</th></tr>
                ...
                <tbody>
                  ...
                  <td>
                    ...
                    <a class="btn btn-primary" href="{{route('faqs.update',$faq->id)}}"><i class="fa fa-edit"></i></a>
                    <a class="btn btn-danger" href="{{route('faqs.destroy',$faq->id)}}"><i class="fa fa-trash"></i></a>
               ...
               @endforeach
                ...
                <tr><th rowspan="1" colspan="1">Faq ID</th><th rowspan="1" colspan="1">Question</th><th rowspan="1" colspan="1">Answer</th><th rowspan="1" colspan="1">Action</th></tr>
