  ...
  <div class="row">
    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form method="post" action="{{route('faqs.update.store',$faq->id)}}" role="form">
          @csrf
          ...
          <div class="box-body">
            <div class="form-group">
              ...
              <input value="{{$faq->question}}" name="question" type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Question">
            </div>
            <div class="form-group">

              <label for="exampleInputPassword1">Answer</label>
              <textarea  id="answer" class="form-control" name="answer" rows="10">{{$faq->answer}}</textarea>
            </div>
