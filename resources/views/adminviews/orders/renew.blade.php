    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Re New Order Here</h3>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
        <form method="post" action="{{route('save.renew.order',$order->id)}}" role="form">
          @csrf
          ...
          <div class="box-body">
            ...
            <select name="package_id" class="form-control">
              ...
              <option value="{{$package->id}}" @if($package->id==$order->package_id) selected @endif>{{$package->title}}</option>
