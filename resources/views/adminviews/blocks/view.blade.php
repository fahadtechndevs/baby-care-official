      ...
      <div class="box">
              ...
              <h3 class="box-title">
                <div class="row">
                  ...
                  <div class="col-md-6 text-right">
                    <a class="btn btn-primary" href="{{route('block.create')}}"><i class="fa fa-plus"></i> Add Blog</a>
                  </div>
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                ...
                <tr role="row"><th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending" style="width: 125.8px;">Blog ID</th><th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 157px;">Title</th><th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 138.6px;">Image</th><th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 138.6px;">Action</th></tr>
                ...
                <tbody>
                  ...
                  <td><img style="width: 100px;height: 100px;" src="{{Storage::disk('public')->url($blog->image)}}"></td>

                  <td>
                    <a class="btn btn-primary" href="{{route('block.edit.show',$blog->id)}}"><i class="fa fa-pencil"></i></a>
                     <a class="btn btn-danger" href="{{route('block.destroy',$blog->id)}}"><i class="fa fa-trash"></i></a>
               ...
               @endforeach
                ...
                <tr><th rowspan="1" colspan="1">Blog ID</th><th rowspan="1" colspan="1">Title</th><th rowspan="1" colspan="1">Image</th><th rowspan="1" colspan="1">Action</th></tr>
