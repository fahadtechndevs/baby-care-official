  ...
  <div class="row">
    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        ...
        <form method="post" action="{{route('block.store')}}" role="form" enctype="multipart/form-data">
          @csrf
         ...
         <div class="box-body">
          ...
          <div class="form-group">
            ...
            <input name="image" type="file" class="form-control" id="exampleInputEmail1" placeholder="Enter Question">
          ...
          <div class="form-group">
            ...
            <textarea id="details" class="form-control" name="details" rows="10">
            </textarea>
