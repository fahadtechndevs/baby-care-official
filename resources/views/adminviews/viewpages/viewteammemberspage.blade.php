  ...
  <div class="row">
    ...
    <div class="col-md-12">
      ...
      <div class="box">
        ...
        <div class="box-body">
          @if(session('teammembersmsg'))
            {!!session('teammembersmsg')!!}
          @endif
          <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
            ...
            <thead>
              ...
              <tr role="row">
                ...
                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 138.6px;">Designation</th>
                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 138.6px;">Contact</th>
            ...
            <tbody>
             ...
             <tr role="row" class="even">
              <td> {{$member->name}} </td>
              <td> <img width="200px" height="150px" src="{{Storage::disk('public')->url($member->image)}}"></td>
              <td> {{$member->designation}}</td>
              <td> {{$member->contact}}</td>
              <td>
                 <form  method="get" action="{{route('team.edit',$member)}}">
                  @csrf
          ...
          <tfoot>
            <tr><th rowspan="1" colspan="1">Name</th><th rowspan="1" colspan="1">Image</th><th rowspan="1" colspan="1">Designation</th><th rowspan="1" colspan="1">Contact</th><th rowspan="1" colspan="1">Action</th></tr>
          </tfoot>
        </table>
      </div>
