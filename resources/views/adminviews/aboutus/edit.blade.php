  ...
  <div class="row">
    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        ...
        <form method="post" action="{{route('edit.store',$about->id)}}" role="form" enctype="multipart/form-data">
          @csrf
         ...
         <div class="box-body">
          ...
          <div class="form-group">
            ...
            <input  name="title" type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Title" value="{{$about->title}}">

          </div>

          <div class="form-group">
            <img width="300px" height="250px" src="{{Storage::disk('public')->url($about->image)}}">
          ...
          <div class="form-group">
            ...
            <textarea id="details" class="form-control" name="description" rows="10">{{$about->description}}
            </textarea>
